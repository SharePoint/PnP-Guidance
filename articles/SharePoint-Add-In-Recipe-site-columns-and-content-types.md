...
You could apply this example to Content By Search Web Parts, SharePoint apps, mobile SharePoint Add-ins, and any other systems that access the information in the SharePoint sites.
