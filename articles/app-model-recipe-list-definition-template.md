...
- [Event Receivers (SharePoint Add-in model recipe)](https://github.com/OfficeDev/PnP-Guidance/blob/master/articles/app-model-recipe-event-receiver-and-list-event-receiver.md)
...
- [List Instance (SharePoint Add-in model recipe)](https://github.com/OfficeDev/PnP-Guidance/blob/master/articles/app-model-recipe-list-instance.md)
- [Event Receivers (SharePoint Add-in model recipe)](https://github.com/OfficeDev/PnP-Guidance/blob/master/articles/app-model-recipe-event-receiver-and-list-event-receiver.md)
- [Document and list templates with app model (O365 PnP Video)](http://channel9.msdn.com/blogs/OfficeDevPnP/Document-and-list-templates-with-app-model)
