# GetUserPropertyByAccountNameCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(Object sender, GetUserPropertyByAccountNameCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
