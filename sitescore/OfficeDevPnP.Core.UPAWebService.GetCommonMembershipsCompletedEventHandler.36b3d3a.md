# GetCommonMembershipsCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public virtual IAsyncResult BeginInvoke(Object sender, GetCommonMembershipsCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
