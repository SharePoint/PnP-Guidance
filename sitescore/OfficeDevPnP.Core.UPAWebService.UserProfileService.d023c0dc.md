# UserProfileService.add_GetProfileSchemaNameByAccountNameCompleted Method  
...
## Syntax
```C#
public void add_GetProfileSchemaNameByAccountNameCompleted(GetProfileSchemaNameByAccountNameCompletedEventHandler value)
```
### Parameters
#### value  
