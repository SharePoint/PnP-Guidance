# GetUserPinnedLinksCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public virtual IAsyncResult BeginInvoke(Object sender, GetUserPinnedLinksCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
