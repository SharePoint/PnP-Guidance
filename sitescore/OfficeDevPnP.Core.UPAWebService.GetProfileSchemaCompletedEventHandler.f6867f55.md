# GetProfileSchemaCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(Object sender, GetProfileSchemaCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
