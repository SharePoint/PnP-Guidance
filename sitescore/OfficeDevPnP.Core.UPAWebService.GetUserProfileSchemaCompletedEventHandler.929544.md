# GetUserProfileSchemaCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(Object sender, GetUserProfileSchemaCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
