# UserProfileService.remove_RemoveAllMembershipsCompleted Method  
...
## Syntax
```C#
public void remove_RemoveAllMembershipsCompleted(RemoveAllMembershipsCompletedEventHandler value)
```
### Parameters
#### value  
