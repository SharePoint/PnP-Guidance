# AddLinkCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(Object sender, AddLinkCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
