# GetUserPropertyByAccountNameCompletedEventHandler.Invoke Method  
...
## Syntax
```C#
public void virtual Invoke(Object sender, GetUserPropertyByAccountNameCompletedEventArgs e)
```
### Parameters
#### sender  
