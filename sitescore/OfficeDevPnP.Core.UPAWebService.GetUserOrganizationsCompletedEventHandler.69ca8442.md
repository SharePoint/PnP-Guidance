# GetUserOrganizationsCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(Object sender, GetUserOrganizationsCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
