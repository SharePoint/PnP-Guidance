# UserProfileService.remove_GetUserPropertyByAccountNameCompleted Method  
...
## Syntax
```C#
public void remove_GetUserPropertyByAccountNameCompleted(GetUserPropertyByAccountNameCompletedEventHandler value)
```
### Parameters
#### value  
