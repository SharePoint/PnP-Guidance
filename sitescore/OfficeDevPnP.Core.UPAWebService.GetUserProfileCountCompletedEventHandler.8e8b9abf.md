# GetUserProfileCountCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public virtual IAsyncResult BeginInvoke(Object sender, GetUserProfileCountCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
