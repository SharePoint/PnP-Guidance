# AddColleagueWithoutEmailNotificationCompletedEventHandler.Invoke Method  
...
## Syntax
```C#
public void Invoke(Object sender, AddColleagueWithoutEmailNotificationCompletedEventArgs e)
```
### Parameters
#### sender  
