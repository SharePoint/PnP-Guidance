...
## Syntax
```C#
public static void AddPermissionLevelToGroup(this SecurableObject securableObject, String groupName, RoleType permissionLevel, Boolean removeExistingPermissionLevels = False)
```
### Parameters
#### securableObject  
