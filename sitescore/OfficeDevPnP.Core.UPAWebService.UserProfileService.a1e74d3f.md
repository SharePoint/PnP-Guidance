# UserProfileService.add_GetUserOrganizationsCompleted Method  
...
## Syntax
```C#
public void add_GetUserOrganizationsCompleted(GetUserOrganizationsCompletedEventHandler value)
```
### Parameters
#### value  
