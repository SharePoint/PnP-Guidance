# UserProfileService.remove_CreateUserProfileByAccountNameCompleted Method  
...
## Syntax
```C#
public void remove_CreateUserProfileByAccountNameCompleted(CreateUserProfileByAccountNameCompletedEventHandler value)
```
### Parameters
#### value  
