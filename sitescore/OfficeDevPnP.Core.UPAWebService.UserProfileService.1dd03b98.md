# UserProfileService.remove_GetCommonMembershipsCompleted Method  
...
## Syntax
```C#
public void remove_GetCommonMembershipsCompleted(GetCommonMembershipsCompletedEventHandler value)
```
### Parameters
#### value  
