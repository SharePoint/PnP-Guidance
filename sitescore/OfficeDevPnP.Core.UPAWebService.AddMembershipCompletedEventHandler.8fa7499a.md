# AddMembershipCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public virtual IAsyncResult BeginInvoke(Object sender, AddMembershipCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
