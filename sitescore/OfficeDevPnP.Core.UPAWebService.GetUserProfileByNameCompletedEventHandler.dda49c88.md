# GetUserProfileByNameCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(Object sender, GetUserProfileByNameCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
