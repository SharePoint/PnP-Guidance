# UserProfileService.add_GetUserProfileSchemaCompleted Method  
...
## Syntax
```C#
public void add_GetUserProfileSchemaCompleted(GetUserProfileSchemaCompletedEventHandler value)
```
### Parameters
#### value  
