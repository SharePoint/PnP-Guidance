# UserProfileService.remove_GetUserProfileSchemaCompleted Method  
...
## Syntax
```C#
public void remove_GetUserProfileSchemaCompleted(GetUserProfileSchemaCompletedEventHandler value)
```
### Parameters
#### value  
