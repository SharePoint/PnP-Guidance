# GetCommonColleaguesCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(Object sender, GetCommonColleaguesCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
