# GetProfileSchemaNameByAccountNameCompletedEventHandler.Invoke Method  
...
## Syntax
```C#
public void virtual Invoke(Object sender, GetProfileSchemaNameByAccountNameCompletedEventArgs e)
```
### Parameters
#### sender  
