# XMLTemplateProvider.GetTemplate Method  
...
## Syntax
```C#
public ProvisioningTemplate virtual GetTemplate(String uri, String identifier, ITemplateFormatter formatter, ITemplateProviderExtension[] extensions)
```
### Parameters
#### uri  
