# GetCommonManagerCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(Object sender, GetCommonManagerCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
