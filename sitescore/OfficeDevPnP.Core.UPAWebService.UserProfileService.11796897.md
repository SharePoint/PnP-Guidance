# UserProfileService.remove_GetUserProfileCountCompleted Method  
...
## Syntax
```C#
public void remove_GetUserProfileCountCompleted(GetUserProfileCountCompletedEventHandler value)
```
### Parameters
#### value  
