# GetPropertyChoiceListCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(Object sender, GetPropertyChoiceListCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
