# GetUserLinksCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public virtual IAsyncResult BeginInvoke(Object sender, GetUserLinksCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
