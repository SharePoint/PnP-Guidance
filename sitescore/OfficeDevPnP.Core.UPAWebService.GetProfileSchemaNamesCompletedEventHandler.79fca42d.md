# GetProfileSchemaNamesCompletedEventHandler.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult BeginInvoke(Object sender, GetProfileSchemaNamesCompletedEventArgs e, AsyncCallback callback, Object object)
```
### Parameters
#### sender  
