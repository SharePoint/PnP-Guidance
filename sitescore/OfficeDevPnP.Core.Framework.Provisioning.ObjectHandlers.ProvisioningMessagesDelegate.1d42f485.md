# ProvisioningMessagesDelegate.BeginInvoke Method  
...
## Syntax
```C#
public IAsyncResult virtual BeginInvoke(String message, ProvisioningMessageType messageType, AsyncCallback callback, Object object)
```
### Parameters
#### message  
